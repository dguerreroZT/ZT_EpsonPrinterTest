...
function PrinterObject(eposdev, properties) {
	...
	this.SHOPID = "EPSON TEST";
	this.ADDRESS = "Zafiro";
	this.TEL = "01-234-5678";
	...
	function cbCreateDevice(deviceObj, code){
		...
		if ( code == "OK" ){
			...
			if ( self.retry < 5 ) {
                log("Impresora en uso. Esperando para volver conectar...")
				setTimeout(function () {
...
PrinterObject.prototype = {
	...
	*/
	PrintReciept : function (paperWidth, purchases) {
		...
		this.deviceObj.addText('\n\n');
		this.deviceObj.addText('Prueba de impresión');
		this.deviceObj.addText('\n');
		
		switch(paperWidth) {
 			case PAPER_WIDTH.PAPER_WIDTH_58MM:
				 this.deviceObj.addText('Esta es una prueba \n de impresión');
				break;
			case PAPER_WIDTH.PAPER_WIDTH_80MM:
				this.deviceObj.addText('Esta es una prueba de impresión');
				break;
			default:
				break;
		}
        ...
        */
		...
		// Total
		this.deviceObj.addTextDouble(true);
		this.deviceObj.addText("CCC");
		this.deviceObj.addText("ccc");
		this.deviceObj.addTextDouble(false);
		this.deviceObj.addText('\n\n');

		// Deposit
		this.deviceObj.addText("DDD");
		this.deviceObj.addText("ddd");
		this.deviceObj.addText('\n');

		// Change
		this.deviceObj.addTextDouble(true);
		this.deviceObj.addText("EEE");
		this.deviceObj.addText("eee");
		this.deviceObj.addTextDouble(false);
		this.deviceObj.addText('\n\n');
		...
		// Footer
		this.deviceObj.addTextAlign(this.deviceObj.ALIGN_CENTER);
		this.deviceObj.addText("Powered by Zafiro");
